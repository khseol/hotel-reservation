 ...
 * Class is specifically used for servicing the manipulation of data in the 
...
public class Patron_Service {
	...
	public boolean saveUser (User_Information patron) throws SQLException{
		return patronService.save(patron); //the patron object will be type casted when passing through the method execution process.
	}
	
	public List<User_Information> listAllUsers()throws SQLException{
